...
Many of the developed apps here are also based on research studies and articles where the author was inspired to design an app for simplicity in use and output generation.

Several apps are still on the pipeline and some apps are always updated for new feature/s or for code robustness.
